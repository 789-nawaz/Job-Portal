...
from jobportal.views import UserRegisterationView, UserLoginView,UserPersonalInfoView, UserEducationView, UserExperienceView, UserSkillsView, UserProfileView
